...
import { handleImageToHD } from './FITUR_BY_WILY/AUTO/AutoGambarHd.js'; // Import HD image handler
...
const startSock = async () => {
	...
	Wilykun.ev.on('messages.upsert', async ({ messages }) => {
		...
		await handleHalloMessage(Wilykun, m);
		// Handle anti motion tag and group mention
